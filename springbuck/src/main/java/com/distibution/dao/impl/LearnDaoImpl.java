...
/**
 * Created by caokuang on 2017/4/8.
 */
@Repository
public class LearnDaoImpl  implements LearnDao {
    ...
    public List<LearnResouce> queryLearnResouces() {
        return jdbcTemplate.query("select * from learn_resource where 1 = 1", new BeanPropertyRowMapper(LearnResouce.class));
    }
}
